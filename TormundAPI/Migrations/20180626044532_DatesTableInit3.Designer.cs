...
namespace TormundAPI.Migrations
{
    ...
    [Migration("20180626044532_DatesTableInit3")]
    partial class DatesTableInit3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Model.Comercial.Customers.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Model.Dates.Date", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int?>("Employee_idId");

                    b.Property<string>("FromApp");
            ...
            modelBuilder.Entity("Model.Common.Phone", b =>
                {
                    b.HasOne("Model.Comercial.Customers.Customer")
                        .WithMany("Phones")
            ...
            modelBuilder.Entity("Model.Dates.Date", b =>
                {
                    ...
                    b.HasOne("Model.Solution.Users.User", "CreatedBy")
                        .WithMany()
                        .HasForeignKey("CreatedById");

                    b.HasOne("Model.Comercial.Customers.Customer", "Customer")
                        .WithMany("Dates")
                        .HasForeignKey("CustomerId");

                    b.HasOne("Model.Comercial.Customers.Customer", "Customer_id")
                        .WithMany()
                        .HasForeignKey("Customer_idId");

                    b.HasOne("Model.Comercial.Employees.Employee", "Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeId");

                    b.HasOne("Model.Comercial.Employees.Employee", "Employee_id")
                        .WithMany()
                        .HasForeignKey("Employee_idId");

                    b.HasOne("Model.Solution.Users.User", "ModifiedBy")
                        .WithMany()
                        .HasForeignKey("ModifiedById");

                    b.HasOne("Model.Comercial.Services.Service", "Service")
                        .WithMany()
